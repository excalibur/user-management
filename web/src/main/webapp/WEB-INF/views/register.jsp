...
<form id="registerform" class="form-vertical<c:if test="${error}"> error</c:if>" method="post">
    <div class="control-group normal-text"><h3>注册</h3></div>
    <div class="control-group">
        <div class="controls">
            <div class="add-input text-right">
                ...
                <input type="text" placeholder="账号" name="username" id="username" value="${user.username}">
    ...
    <div class="control-group">
        <div class="controls">
            <div class="add-input text-right">
                ...
                <input type="text" placeholder="姓名" name="name" id="name" value="${user.username}">
                <c:if test="${name != null }">
                    <p>${name.message}</p>
                </c:if>
            </div>
